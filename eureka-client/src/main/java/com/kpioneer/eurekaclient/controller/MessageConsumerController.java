package com.kpioneer.eurekaclient.controller;

import com.kpioneer.eurekaclient.config.HttpClientConfig;
...
public class MessageConsumerController {
    ...
    public String getMessage(@RequestParam("name") String name) {
        ...
        String requestUrl = "http://ms-provider-order/get?name="+name;
